...
import com.rutong.framework.bean.enums.BusinessStatus;
import com.rutong.framework.filter.PropertyPreExcludeFilter;
...
import com.rutong.framework.utils.ExceptionUtil;
...
public class OperLogAspect {
    ...
    public void doBefore(JoinPoint joinPoint, OperLog controllerLog) {
    ...
    protected void handleLog(final JoinPoint joinPoint, OperLog controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (e != null) {
                ...
                operLog.setErrorMsg(StringUtils.substring(ConvertStr.toStr(e.getMessage(), ExceptionUtil.getExceptionMessage(e)), 0, 2000));
            }
            // 设置方法名称
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, OperLog log, SysOperLog operLog, Object jsonResult) throws Exception {
        // 设置action动作
