package com.rutong.framework.utils.sign;

import com.rutong.framework.exception.UtilException;
	...
	public static String generateSignature(final Map<String, String> data, String key, String signType) {
		...
		if ("MD5".equals(signType)) {
			try {
				...
				throw new UtilException(String.format("加密异常: %s", e.getMessage()));
			}
			...
			throw new UtilException(String.format("Invalid sign_type: %s", signType));
		}
	}
