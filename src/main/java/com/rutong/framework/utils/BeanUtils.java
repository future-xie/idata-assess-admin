...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
	 ...
	 * 
	 * @param object bean对象
	 * @param key    字段名称，例如：UProvince.provinceid
	 * @param value  需要的赋值
	 */
	public static void setData(Object object, String key, Object value) {
		...
		if (keys.length > 1) {
			...
			try {
				...
				boolean condition = ("int".equals(field.getType().getName())
						|| field.getType().equals(Integer.class)) && value != null
...
class MyBeanUtilsBean extends org.apache.commons.beanutils.BeanUtilsBean {
	...
	public static MyBeanUtilsBean getInstance(String[] includes) {
		...
		// BigDecimal 如果是null , 默认设置为0.00, 否则会报错
		cub.register(new BigDecimalConverter(BigDecimal.ZERO), BigDecimal.class);
