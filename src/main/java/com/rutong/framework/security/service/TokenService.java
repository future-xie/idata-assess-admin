...
import com.rutong.configuration.TokenConfig;
...
public class TokenService {
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        caffeineCache.setCacheObject(userKey, loginUser, expireTime, TimeUnit.MINUTES);
    }
...
//        loginUser.setOs(userAgent.getOperatingSystem().getName());
    ...
    public String getUsernameFromToken(String token) {
        Claims claims = parseToken(token);
        // 用户名存储在自定义 claim（Constants.JWT_USERNAME）中，createToken 未设置 subject
    ...
    /**
     * 获取签名密钥（由 TokenConfig 启动时动态生成）
     */
    private SecretKey getSigningKey() {
        return tokenConfig.getSigningKey();
    }
}
